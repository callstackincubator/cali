...
export const getConfirmation = (s: Spinner) => tool({
...
export const presentOptions = (s: Spinner) => tool({
...
export const concludeTask = tool({
    ...
    execute: async ({ conclusion }) => {
        ...
        return response ? "Conclusion presented to user, but he wants to continue conversation" : "Conclusion presented, user wants to end the session";
    },
})